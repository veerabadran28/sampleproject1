...
data = pd.DataFrame()
# Sidebar
user_selection_option = st.sidebar.radio("Choose Option:", ["Explore My Data!", "Explore data from AWS S3!"])
...
with input_container:
    user_query = st.text_input("Enter your query", key='user_query', help="Type your query here")
...
#     """
#     <footer>
#         &copy; 2024 Interactive Data Visualization. All rights reserved.
#     </footer>
#     """,
#     unsafe_allow_html=True
# )